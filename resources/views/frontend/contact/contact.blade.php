  ...
  <div class="featured-section" id="projects">
		<div class="container">
			...
			<div class="content-bottom-in">
				<div class="nbs-flexisel-container"><div class="nbs-flexisel-inner"><ul id="flexiselDemo1" class="nbs-flexisel-ul" style="left: -342px;">
				...
				<li class="nbs-flexisel-item" style="width: 342px;">
					...
					</li></ul><div class="nbs-flexisel-nav-left" style="top: 185px;"></div><div class="nbs-flexisel-nav-right" style="top: 185px;"></div></div></div>
			</div>
		</div>
	</div>
@endsection
